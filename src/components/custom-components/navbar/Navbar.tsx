  ...
  return (
    <NavigationMenu className="">
      <NavigationMenuList className=" space-y-5">
        ...
        <NavigationMenuItem className="border-b-2 border-r-4 border-[#0D6D88] hover:bg-[#0D6D88] hover:text-white cursor-pointer">
          <Link to="/" >
        ...
        <NavigationMenuItem className="border-b-2 border-r-4 border-[#0D6D88] hover:bg-[#0D6D88] hover:text-white cursor-pointer ">
          <Link to="/helplines" className="hover:bg-[#0D6D88] hover:text-white">
            <NavigationMenuLink className={navigationMenuTriggerStyle()}>
              Helplines
            </NavigationMenuLink>
          </Link>
