...
const Notice_Board = () => {
  return (
    <div
      className="relative p-5  pb-10 bg-[#f2faff] rounded-md "
      //   style={{
    ...
    >
      ...
      <div className="flex justify-between items-center">
        <h3 className="font-bold text-2xl ml-16">Notice Board</h3>
        <Button size="sm" className="text-[#1697BA]" variant={"outline"}>
          All
        </Button>
      </div>
      <ul className="list-disc list-inside space-y-2 ml-20 text-xs mt-2">
        <li className="hover:underline cursor-pointer flex gap-2 ">
          <svg
